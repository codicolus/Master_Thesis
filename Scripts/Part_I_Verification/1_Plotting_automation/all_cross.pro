...
; Modifications include: plotting of ALL drawn RHI cross section locations on a POI-plot
...
.COMPILE serial_all_cross
.COMPILE all_cross_poi
...
;IF prd EQ "HZT" THEN files=files[where(strmatch(files,"*15000L.802"))]
...
serial_all_cross, files, datadir, moment, [chy1, chy2], [chx1, chx2], trt, [chy1_cross, chy2_cross], [chx1_cross, chx2_cross], howmany
